...
A behavioral experiment that would test whether unsupported numerical specificity affects trust and reliance was previously planned, but that Precision-Illusion behavioral thread was retired on 2026-08-18; no behavioral PI design is active, planned, or current. Active work is human validation of uncertainty-communication measurement toward the combined Precision Illusion + CheckMyCoach paper.
